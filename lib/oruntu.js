...
function yukle() {
  ...
  // Geriye dönük uyumluluk: eski "i"/"c" kayıtları "u" grubunda okunur
  oruntuler = (ham.oruntuler || []).map((o) => ({ ...o, grup: gruplar.normalize(o.grup) }));
...
function havuzOlustur(grupGirdisi, seviye, mod) {
  const grup = gruplar.normalize(grupGirdisi);
...
function temelKayitlar(grup, seviye) {
  ...
  return oruntuler.filter((o) => o.grup === g && o.seviye === seviye && o.mod === 'surdur');
}
